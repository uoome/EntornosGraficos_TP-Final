                ...
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="userType" id="userAdmin" value="admin">
                            <label class="form-check-label" for="userAdmin">Administrador</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="userType" id="userVisitor" value="visitor">
                            <label class="form-check-label" for="userVisitor">Visitante</label>
                        </div>
                    </div>
